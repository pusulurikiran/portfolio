...
const education: Education[] = [
  {
    ...
    study: "Information Technology/NetworkingMaster",
    location: "Vellore, India",
    period: { start: "2014", end: "2016" },
  },
  {
    id: 2,
    logo: "/images/education/sacet.png",
  ...
  {
    id: 3,
    logo: "/images/education/vishwasanthi.png",
    institution: "Viswasanthi English Medium High School",
    degree: "High School",
    study: "Mathematics, Physics and Chemistry",
    location: "Andhra Pradesh, India",
    period: { start: "2007", end: "2008" },
  }
 ];
